...
<div class="content" style="background-color: #ffffff">
    <img src="images/conductor.png" width="150px" style="float: left">
    <ol class="list">
        <li class="list-item one"><a href="creuser.php">Add Customer</a></li>
        <li class="list-item two"><a href="addapp.php">Add Reservation</a></li>
        <li class="list-item three"><a href="upapp.php">Update Reservation</a></li>
